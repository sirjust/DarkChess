...
The script will send every frame a raycast upwards and once the raycast hits a collider, the game object will be saved in a variable called `gameObjectOnTile`.
